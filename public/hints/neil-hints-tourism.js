/**
 * Neil Avatar — Hints Panel [Tourism]
 * <script src="neil-hints-tourism.js"></script> before closing </body>
 */
(function () {
  "use strict";
  ...
  var QUESTIONS = [
    ...
    "What was your very first trip in life like?",
    "Which destination seemed the most risky or dangerous?",
    "Do you prefer traveling in tour groups or independently?",
    "In which country, in your opinion, is the best transportation infrastructure?",
    "Have you had serious injuries during exotic trips?",
    "Did you travel on the Trans-Siberian Railway?",
    "Do you buy travel medical insurance before leaving?",
    "Which country disappointed you the most?",
    "How do you preserve memories of your many trips?",
    "Have you ever been a victim of crime abroad?",
    "What man-made structure in the world impressed you the most?",
    "What is the biggest discovery you made about cultures of different countries?",
    "How do you choose where to dine in an unfamiliar city?",
    "What is the main life lesson you took from visiting 114 countries?"
];
