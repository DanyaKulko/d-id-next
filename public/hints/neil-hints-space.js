/**
 * Neil Avatar — Hints Panel [Space]
 * <script src="neil-hints-space.js"></script> before closing </body>
 */
(function () {
  "use strict";

  var QUESTIONS = [
    "Have you ever been interested in space exploration?",
    "Did you study anything related to the aerospace industry at university?",
    "Why, with that education, did you not go to work in the space industry?",
    "What is your opinion of private spaceflight?",
    "What, in your view, is the main advantage of SpaceX’s engineering approach?",
    "Have you ever attended rocket launches in person?",
    "Have you ever been to foreign historic cosmodromes?",
    "What did you feel watching the capsule land?",
    "Why did your New Shepard flight never happen?",
    "How close physically have you ever come to the edge of space?",
    "Where exactly did your fighter flight take place?",
    "Which modern space device do you consider a true engineering miracle?",
    "How does your engineering education help you evaluate space news?",
    "What space event would you absolutely want to see in the future?"
];
