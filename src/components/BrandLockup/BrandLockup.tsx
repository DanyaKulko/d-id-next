...
/**
 * Brand lockup: looping lamp animation on the left, stacked
 * "Neil Avatar" wordmark + tagline on the right. Shared across the
 * header, the login page and the page footers so the logo stays
 * consistent everywhere.
 */
export default function BrandLockup({ className, asLink = false }: BrandLockupProps) {
  return (
